...
"resource": {
  ...
  "rules":[
    [["if",1],["unless",0],["add",0]],
    [["if",2],["unless",0],["add",1]],
    [["if",3,4],["unless",0],["add",2,3]],
    [["if",6],["unless",0,5],["add",4]],
    [["if",7],["unless",0],["add",4,5]],
    [["if",8,9],["add",6]],
    [["if",10],["unless",0],["add",7]],
    [["if",7],["add",8,9]],
    [["if",3,7],["unless",0],["add",10]]]
},
"runtime":[]
...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var sd=yd;var Nd={},K=null,Od=Math.random();Nd.C="GTM-W3ZFCR2";Nd.Ub="8j2";Nd.Nh="";var Pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Qd="www.googletagmanager.com/gtm.js";
var Rd=Qd,Sd=null,Td=null,Ud="//www.googletagmanager.com/a?id="+Nd.C+"&cv=11",Vd={},Wd={},Xd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
n.vtp_trackType){}else if("TRACK_TRANSACTION"==n.vtp_trackType){C("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");
var M=function(la){return Jl("transaction"+la,1)},T=M("Id");C("ecommerce:addTransaction",{id:T,affiliation:M("Affiliation"),revenue:M("Total"),shipping:M("Shipping"),tax:M("Tax")});for(var R=M("Products")||[],ra=0;ra<R.length;ra++){var oa=R[ra];C("ecommerce:addItem",{id:T,sku:oa.sku,name:oa.name,category:oa.category,price:oa.price,quantity:oa.quantity})}C("ecommerce:send");}else if("TRACK_TIMING"==n.vtp_trackType){}else if("DECORATE_LINK"==n.vtp_trackType){}else if("DECORATE_FORM"==n.vtp_trackType){}else if("TRACK_DATA"==n.vtp_trackType){}else{n.vtp_enableEcommerce&&(C("require","ec","ec.js"),P());if(n.vtp_doubleClick||"DISPLAY_FEATURES"==n.vtp_advertisingFeaturesType){var ja="_dc_gtm_"+String(n.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,
...
(b.vtp_enableCrossDomain&&!1===b.vtp_acceptIncoming||(b.vtp_enableCrossDomain||Tf())&&kg(a,k));hg(k);mg(["aw","dc"],k);vg(h,k);var l=e;if(b.vtp_enableCrossDomainFeature&&b.vtp_enableCrossDomain&&b.vtp_linkerDomains){var p=b.vtp_linkerDomains.toString().replace(/\s+/g,"").split(",");lg(a,p,b.vtp_urlPosition,!!b.vtp_formDecoration,l)}var n=Jl(E.P);Ii(!1,void 0!=n&&!1!==n);b.vtp_enableUrlPassthroughFeature&&b.vtp_enableUrlPassthrough&&og()})}();
...
0})(function(f){var h=W("self");if(!Pl("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);Ql("hl")}I(f.vtp_gtmOnSuccess)})}();
...
Z.__awct=h;Z.__awct.b="awct";Z.__awct.g=!0;Z.__awct.priorityOverride=0}();Z.a.smm=["google"],function(){(function(a){Z.__smm=a;Z.__smm.b="smm";Z.__smm.g=!0;Z.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=ym(a.vtp_map,"key","value")||{};return c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue})}();
