...
function ya(a){a.A=[a.h];a.l=0;a.j=0}
function za(a){var b=a.A.splice(0)[0];(b=a.h=a.h||b)?b.U?a.f=a.l||a.j:void 0!=b.v&&a.j<b.v?(a.f=b.v,a.h=null):a.f=a.j:a.f=0}
...
b.prototype.G=function(g){if(g===this)this.j(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.pa(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.A(g):this.l(g)}};
...
b.prototype.then=function(g,h){function k(r,p){return"function"==typeof r?function(u){try{l(r(u))}catch(w){m(w)}}:p}
...
b.race=function(g){return new b(function(h,k){for(var l=v(g),m=l.next();!m.done;m=l.next())d(m.value).H(h,k)})};
b.all=function(g){var h=v(g),k=h.next();return k.done?d([]):new b(function(l,m){function n(u){return function(w){r[u]=w;p--;0==p&&l(r)}}
var r=[],p=0;do r.push(void 0),p++,d(k.value).H(n(r.length-1),m),k=h.next();while(!k.done)})};
return b});
...
function zc(){var a=nc(),b={};F(yc(),function(c){a.sandbox&&a.sandbox.supports&&a.sandbox.supports(c)&&(b[c]=!0)});
return b}
;function Ac(){this.h=this.h;this.i=this.i}
Ac.prototype.h=!1;Ac.prototype.dispose=function(){this.h||(this.h=!0,this.O())};
Ac.prototype.O=function(){if(this.i)for(;this.i.length;)this.i.shift()()};function L(a,b){var c=void 0;return new (c||(c=Promise))(function(d,e){function f(k){try{h(b.next(k))}catch(l){e(l)}}
...
function b(n){for(var r=g,p=0;64>p;p+=4)r[p/4]=n[p]<<24|n[p+1]<<16|n[p+2]<<8|n[p+3];for(p=16;80>p;p++)n=r[p-3]^r[p-8]^r[p-14]^r[p-16],r[p]=(n<<1|n>>>31)&4294967295;n=e[0];var u=e[1],w=e[2],G=e[3],Ta=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var ka=G^u&(w^G);var Da=1518500249}else ka=u^w^G,Da=1859775393;else 60>p?(ka=u&w|G&(u|w),Da=2400959708):(ka=u^w^G,Da=3395469782);ka=((n<<5|n>>>27)&4294967295)+ka+Ta+Da+r[p]&4294967295;Ta=G;G=w;w=(u<<30|u>>>2)&4294967295;u=n;n=ka}e[0]=e[0]+n&4294967295;e[1]=e[1]+
u&4294967295;e[2]=e[2]+w&4294967295;e[3]=e[3]+G&4294967295;e[4]=e[4]+Ta&4294967295}
function c(n,r){if("string"===typeof n){n=unescape(encodeURIComponent(n));for(var p=[],u=0,w=n.length;u<w;++u)p.push(n.charCodeAt(u));n=p}r||(r=n.length);p=0;if(0==l)for(;p+64<r;)b(n.slice(p,p+64)),p+=64,m+=64;for(;p<r;)if(f[l++]=n[p++],m++,64==l)for(l=0,b(f);p+64<r;)b(n.slice(p,p+64)),p+=64,m+=64}
function d(){var n=[],r=8*m;56>l?c(h,56-l):c(h,64-(l-56));for(var p=63;56<=p;p--)f[p]=r&255,r>>>=8;b(f);for(p=r=0;5>p;p++)for(var u=24;0<=u;u-=8)n[r++]=e[p]>>u&255;return n}
...
;function Hc(a,b,c){var d=[],e=[];if(1==(Array.isArray(c)?2:1))return e=[b,a],F(d,function(h){e.push(h)}),Ic(e.join(" "));
...
function zd(a,b){if(Qa(a))try{F(a,b,void 0)}catch(c){if(c!==wd)throw c;}else{a=yd(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==wd)throw c;}}}
...
M.prototype.then=function(a,b,c){return Md(this,Ra(a)?a:null,Ra(b)?b:null,c)};
...
q.L=function(a){var b=this.f[a];if(b){var c=this.g[b];if(0!=this.l)this.j.push(a),this.f[a+1]=Oa;else{if(c){var d=bb(c,a);0<=d&&Array.prototype.splice.call(c,d,1)}delete this.f[a];delete this.f[a+1];delete this.f[a+2]}}return!!b};
q.J=function(a,b){var c=this.g[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.s)for(e=0;e<c.length;e++){var g=c[e];$d(this.f[g+1],this.f[g+2],d)}else{this.l++;try{for(e=0,f=c.length;e<f;e++)g=c[e],this.f[g+1].apply(this.f[g+2],d)}finally{if(this.l--,0<this.j.length&&0==this.l)for(;c=this.j.pop();)this.L(c)}}return 0!=e}return!1};
function $d(a,b,c){Uc(function(){a.apply(b,c)})}
q.clear=function(a){if(a){var b=this.g[a];b&&(F(b,this.L,this),delete this.g[a])}else this.f.length=0,this.g={}};
q.O=function(){O.F.O.call(this);this.clear();this.j.length=0};function ae(a){this.f=a}
...
;function ge(){}
E(ge,fe);ge.prototype.clear=function(){var a=Ad(this.B(!0)),b=this;F(a,function(c){b.remove(c)})};function he(a){this.f=a}
...
function Be(a){a&&("string"==typeof a&&(a=[a]),F(a,function(b){if(b in pb){var c=pb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Ce()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete pb[b]}}))}
...
;function Ge(a){var b=[];nb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];F(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
...
;var Le={},Me=[],Zd=new O,Ne={};function Oe(){for(var a=v(Me),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
Re.prototype.i=function(a){if(a.origin==S(this,"host")||a.origin==S(this,"host").replace(/^http:/,"https:")){try{var b=JSON.parse(a.data)}catch(c){return}this.h=!0;this.f||0!=a.origin.indexOf("https:")||(this.f=!0);if(a=Te[b.id])a.s=!0,a.s&&(F(a.m,a.S,a),a.m.length=0),a.ba(b)}};
...
function Zf(a){var b=Qf,c=Math.round(U());a=v(a);for(var d=a.next();!d.done;d=a.next()){var e=v(d.value);d=e.next().value;var f=e.next().value;e=rb({context:ag(b.f||bg())});e.events=f;(f=Xf[d])&&cg(e,d,f);delete Xf[d];dg(e,c);eg(b,"log_event",e,{retry:!0,onSuccess:function(){Pf=Math.round(U()-c)}});
Uf=!1}}
...
og=!1;
function pg(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=a.match(pc)[1]||null,e=K(a);d&&e?(d=c,c=a.match(pc),d=d.match(pc),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?K(c)==e&&(Number(c.match(pc)[4]||null)||null)==(Number(a.match(pc)[4]||null)||null):!0;d=T("web_ajax_ignore_global_headers_if_set");for(var f in mg)e=P(mg[f]),!e||!c&&K(a)||d&&void 0!==b[f]||(b[f]=e);if(c||!K(a))b["X-YouTube-Utc-Offset"]=String(-(new Date).getTimezoneOffset());(c||!K(a))&&(f="undefined"!=typeof Intl?(new Intl.DateTimeFormat).resolvedOptions().timeZone:
null)&&(b["X-YouTube-Time-Zone"]=f);if(c||!K(a))b["X-YouTube-Ad-Signals"]=Ge(gg(void 0));return b}
function qg(a){var b=window.location.search,c=K(a),d=qc(a.match(pc)[5]||null);d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=He(b),f={};F(ng,function(g){e[g]&&(f[g]=e[g])});
return Ie(a,f||{},!1)}
...
function tg(a,b){var c=P("XSRF_FIELD_NAME",void 0),d=P("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.u,g=P("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.Ha||K(a)&&!b.withCredentials&&K(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.u&&b.u[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=He(e),tb(e,f),e=b.aa&&"JSON"==b.aa?JSON.stringify(e):tc(e));if(!(c=e)&&(c=f)){a:{for(var k in f){f=!1;break a}f=!0}c=!f}!og&&c&&"POST"!=b.method&&
(og=!0,ue(Error("AJAX request with postData should use POST")));return e}
function wg(a,b,c,d){var e=null;switch(b){case "JSON":try{var f=c.responseText}catch(g){throw d=Error("Error reading responseText"),d.params=a,ve(d),g;}a=c.getResponseHeader("Content-Type")||"";f&&0<=a.indexOf("json")&&(e=JSON.parse(f));break;case "XML":if(a=(a=c.responseXML)?xg(a):null)e={},F(a.getElementsByTagName("*"),function(g){e[g.tagName]=yg(g)})}d&&zg(e);
return e}
function zg(a){if(Sa(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=a[b];if(void 0===ub){var e=null;var f=A.trustedTypes;if(f&&f.createPolicy){try{e=f.createPolicy("goog#html",{createHTML:$a,createScript:$a,createScriptURL:$a})}catch(g){A.console&&A.console.error(g.message)}ub=e}else ub=e}(e=ub)&&e.createHTML(d);a[c]=new Fb}else zg(a[b])}}
function xg(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function yg(a){var b="";F(a.childNodes,function(c){b+=c.nodeValue});
return b}
...
return k}
;function Ag(){for(var a={},b=v(Object.entries(He(P("DEVICE","")))),c=b.next();!c.done;c=b.next()){var d=v(c.value);c=d.next().value;d=d.next().value;"cbrand"===c?a.deviceMake=d:"cmodel"===c?a.deviceModel=d:"cbr"===c?a.browserName=d:"cbrver"===c?a.browserVersion=d:"cos"===c?a.osName=d:"cosver"===c?a.osVersion=d:"cplatform"===c&&(a.platform=d)}return a}
...
function W(a){var b=this;this.g=a;this.state={status:"PENDING"};this.f=[];this.onRejected=[];this.g(function(c){if("PENDING"===b.state.status){b.state={status:"FULFILLED",value:c};c=v(b.f);for(var d=c.next();!d.done;d=c.next())d=d.value,d()}},function(c){if("PENDING"===b.state.status){b.state={status:"REJECTED",
...
q=Xg.prototype;q.add=function(a,b,c){return Yg(this,[a],"readwrite",function(d){return Zg(d,a).add(b,c)})};
q.clear=function(a){return Yg(this,[a],"readwrite",function(b){return Zg(b,a).clear()})};
q.close=function(){this.f.close()};
q.count=function(a,b){return Yg(this,[a],"readonly",function(c){return Zg(c,a).count(b)})};
function $g(a,b,c){a=a.f.createObjectStore(b,c);return new ah(a)}
q["delete"]=function(a,b){return Yg(this,[a],"readwrite",function(c){return Zg(c,a)["delete"](b)})};
q.get=function(a,b){return Yg(this,[a],"readwrite",function(c){return Zg(c,a).get(b)})};
...
q=ah.prototype;q.add=function(a,b){var c=b?this.f.add(a,b):this.f.add(a);return X(c)};
...
q.index=function(a){return new fh(this.f.index(a))};
...
;var lh,mh,nh=["getAll","getAllKeys","getKey","openKeyCursor"],oh=["getAll","getAllKeys","getKey","openKeyCursor"];function ph(){var a;if(a=Mg)a=/WebKit\/([0-9]+)/.exec(H),a=!!(a&&600<=parseInt(a[1],10));a&&(a=/WebKit\/([0-9]+)/.exec(H),a=!(a&&602<=parseInt(a[1],10)));return a&&!T("ytidb_allow_on_ios_safari_v8_and_v9")?!1:!!self.indexedDB}
function qh(){return new Promise(function(a){setTimeout(a,50)})}
function rh(){return L(this,function b(){var c,d,e;return y(b,function(f){switch(f.f){case 1:if(!ph())return f["return"](!1);wa(f);d=!1;return x(f,kh("yt-idb-test-do-not-use",void 0,{blocking:function(){d=!0;c&&(c.close(),c=void 0)}}),5);
...
function th(){return void 0!==mh?Kd(mh):sh().then(function(a){if(!a)return!1;var b=v(nh);for(a=b.next();!a.done;a=b.next())if(!IDBObjectStore.prototype[a.value])return!1;b=v(oh);for(a=b.next();!a.done;a=b.next())if(!IDBIndex.prototype[a.value])return!1;return IDBObjectStore.prototype.getKey?!0:!1}).then(function(a){return mh=a})}
...
sa(Ah,W);Ah.reject=W.reject;Ah.resolve=W.resolve;Ah.all=W.all;var Bh;function Ch(){return L(this,function b(){return y(b,function(c){if(!Bh)try{Bh=zh(1,{upgrade:function(d,e){1>e&&($g(d,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).f.createIndex("newRequest",["status","authHash","timestamp"],{unique:!1}),$g(d,"sapisid"))}})}catch(d){if(!Ug(d))return ue(d),c["return"](Promise.reject(d));
...
function Gh(a){return L(this,function c(){var d;return y(c,function(e){if(1==e.f)return x(e,Ch(),2);d=e.g;return e["return"](Yg(d,["LogsRequestsStore"],"readwrite",function(f){var g=Zg(f,"LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",ch(g,h).then(function(){return h})})}))})})}
function Hh(a){return L(this,function c(){var d;return y(c,function(e){if(1==e.f)return x(e,Ch(),2);d=e.g;return e["return"](Yg(d,["LogsRequestsStore"],"readwrite",function(f){var g=Zg(f,"LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,ch(g,h).then(function(){return h})):Ah.resolve(void 0)})}))})})}
...
function Eh(){return L(this,function b(){var c;return y(b,function(d){if(1==d.f){Lg.f||(Lg.f=new Lg);var e={};var f=Jc([]);f&&(e.Authorization=f,e["X-Goog-AuthUser"]=P("SESSION_INDEX",0),"INNERTUBE_HOST_OVERRIDE"in pe||(e["X-Origin"]=window.location.origin),T("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in pe&&(e["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));e=Kd(e);return x(d,e,2)}c=d.g;return d["return"](Eg(c))})})}
;var Kh=Ve("network_polling_interval",3E4);function Lh(){this.i=0;this.f=window.navigator.onLine;Mh(this);Nh(this)}
function Oh(){Lh.f||(Lh.f=new Lh);return Lh.f}
function Ph(a){var b=Qh,c=Rh;(new M(function(d){a.g=d})).then(function(){b();
c&&(a.h=c)});
Sh(a)}
...
function Th(a){a.i=Xe(function(){window.navigator.onLine?(!1===a.f&&ue(Error("NetworkStatusManager missed online event.")),a.f=!0,a.g&&a.g()):(!0===a.f&&ue(Error("NetworkStatusManager missed offline event.")),a.f=!1,a.h&&a.h());Th(a)},Kh)}
;var Uh=Ve("networkless_throttle_timeout")||100,Vh=Ve("networkless_retry_attempts")||1,Wh=0;function Xh(a,b){b=void 0===b?{}:b;Yh().then(function(c){if(c&&!T("networkless_bypass_write")){var d={url:a,options:b,timestamp:U(),status:"NEW",sendCount:0};Dh(d).then(function(e){d.id=e;e=Oh();e.f&&!T("networkless_always_offline")?Zh(d):Ph(e)})["catch"](function(e){Zh(d);
ue(e)})}else ug(a,b)})}
function Qh(){Wh||(Wh=Ye(function(){Zh();Wh=0;Qh()},1,Uh))}
function Rh(){var a=Wh;if(!isNaN(a)){var b=B("yt.scheduler.instance.cancelJob");b?b(a):window.clearTimeout(a)}Wh=0}
function Zh(a){L(this,function c(){var d=this,e,f,g,h,k;return y(c,function(l){switch(l.f){case 1:e=d;if(!a)return x(l,Fh(),6);if(!a.id){l.v(3);break}return x(l,Gh(a.id),5);case 5:(f=l.g)?a=f:ve(Error("The request cannot be found in the database."));l.v(3);break;case 6:if(a=l.g){l.v(3);break}return x(l,Ih(),8);case 8:return(g=l.g)&&Rh(),l["return"]();case 3:if($h(a))h=a.options.onError?a.options.onError:function(){},k=a.options.onSuccess?a.options.onSuccess:function(){},a.options.onError=function(m,
n){return L(e,function p(){return y(p,function(u){if(1==u.f)return a&&a.id?a.sendCount<Vh?x(u,Hh(a.id),6):x(u,Jh(a.id),2):u.v(2);
2!=u.f&&(Wh||Ph(Oh()),h(m,n));h(m,n);u.f=0})})},a.options.onSuccess=function(m,n){return L(e,function p(){return y(p,function(u){if(1==u.f)return a&&a.id?x(u,Jh(a.id),2):u.v(2);
k(m,n);u.f=0})})},ug(a.url,a.options);
else if(ve(Error("Networkless Logging: Stored logs request expired age limit")),a.id)return x(l,Jh(a.id),0);l.v(0)}})})}
function $h(a){a=a.timestamp;return 2592E6<=U()-a?!1:!0}
function Yh(){return L(this,function b(){return y(b,function(c){return T("networkless_logging")?(2===Ve("networkless_ytidb_version")&&th().then(function(d){return d}),c["return"](ph())):c["return"](!1)})})}
;function ai(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ia(v(c)))}
sa(ai,Error);function bi(a){var b=this;this.f=null;a?this.f=a:Bg()&&(this.f=bg());Xe(function(){Kg(b)},5E3)}
bi.prototype.isReady=function(){!this.f&&Bg()&&(this.f=bg());return!!this.f};
function eg(a,b,c,d){!P("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ve(new ai("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new ai("innertube xhrclient not ready",b,c,d);ue(e);e.sampleWeight=0;throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",u:c,aa:"JSON",I:function(){d.I()},
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.f.ka)&&(g=e);var h=a.f.ma||!1,k=Cg(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.f.innertubeApiVersion+"/"+b;var l={alt:"json"};a.f.la&&f.headers.Authorization||(l.key=a.f.innertubeApiKey);var m=Ie(""+g+e,l||{},!0);Yh().then(function(n){if(d.retry&&T("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(T("networkless_gel")&&!n||!T("networkless_gel"))var r=Ig(b,
c,k,h);if(r){var p=f.onSuccess,u=f.X;f.onSuccess=function(w,G){Jg(r);p(w,G)};
c.X=function(w,G){Jg(r);u(w,G)}}}try{T("use_fetch_for_op_xhr")?rg(m,f):T("networkless_gel")&&d.retry?(f.method="POST",Xh(m,f)):(f.method="POST",f.u||(f.u={}),ug(m,f))}catch(w){if("InvalidAccessError"==w.name)r&&(Jg(r),r=0),ve(Error("An extension is blocking network request."));
else throw w;}r&&Xe(function(){Kg(a)},5E3)})}
;var ci=[{W:function(a){return"Cannot read property '"+a.key+"'"},
...
;function Y(a,b,c){this.l=this.f=this.g=null;this.j=Ua(this);this.h=0;this.s=!1;this.m=[];this.i=null;this.A=c;this.G={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?rc(a.src):"https://www.youtube.com"),this.g=new Re(b),c||(b=ki(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+Ua(this.f)),Le[this.f.id]=this,window.postMessage){this.i=new O;li(this);b=S(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
this.addEventListener(d,b[d]);for(var e in Ne)mi(this,e)}}
q=Y.prototype;q.setSize=function(a,b){this.f.width=a;this.f.height=b;return this};
q.na=function(){return this.f};
q.ba=function(a){this.K(a.event,a)};
...
q.M=function(){return{}};
function oi(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.s?a.S(b):a.m.push(b)}
q.K=function(a,b){if(!this.i.h){var c={target:this,data:b};this.i.J(a,c);Qe(this.A+"."+a,c)}};
...
window.postMessage?1:0;window.location.host&&(h.origin=window.location.protocol+"//"+window.location.host);h.widgetid=a.j;window.location.href&&F(["debugjs","debugcss"],function(k){var l=window.location.href;var m=l.search(uc);b:{var n=0;for(var r=k.length;0<=(n=l.indexOf(k,n))&&n<m;){var p=l.charCodeAt(n-1);if(38==p||63==p)if(p=l.charCodeAt(n+r),!p||61==p||38==p||35==p)break b;n+=r+1}n=-1}if(0>n)l=null;else{r=l.indexOf("&",n);if(0>r||r>m)r=m;n+=k.length+1;l=decodeURIComponent(l.substr(n,r-n).replace(/\+/g,
" "))}null!==l&&(h[k]=l)});
...
function li(a){Se(a.g,a,a.j);a.h=Fe(Za(a.Z,a));De(a.f,"load",Za(function(){window.clearInterval(this.h);this.h=Fe(Za(this.Z,this))},a))}
function ni(a,b){a.G[b]||(a.G[b]=!0,oi(a,"addEventListener",[b]))}
q.S=function(a){a.id=this.j;a.channel="widget";var b=Fd(a),c=this.g,d=rc(this.f.src||"");var e=0==d.indexOf("https:")?[d]:c.f?[d.replace("http:","https:")]:c.h?[d]:[d,d.replace("http:","https:")];if(this.f.contentWindow)for(var f=0;f<e.length;f++)try{this.f.contentWindow.postMessage(b,e[f])}catch(Ka){if(Ka.name&&"SyntaxError"==Ka.name){if(!(Ka.message&&0<Ka.message.indexOf("target origin ''"))){var g=void 0,h=void 0,k=Ka;h=void 0===h?{}:h;h.name=P("INNERTUBE_CONTEXT_CLIENT_NAME",1);h.version=P("INNERTUBE_CONTEXT_CLIENT_VERSION",
void 0);var l=h||{},m="WARNING";m=void 0===m?"ERROR":m;g=void 0===g?!1:g;if(k){if(T("console_log_js_exceptions")){var n=k,r=[];r.push("Name: "+n.name);r.push("Message: "+n.message);n.hasOwnProperty("params")&&r.push("Error Params: "+JSON.stringify(n.params));r.push("File name: "+n.fileName);r.push("Stacktrace: "+n.stack);window.console.log(r.join("\n"),n)}if((window&&window.yterr||g)&&!(5<=hi)&&0!==k.sampleWeight){var p=void 0,u=k,w=l,G=fc(u),Ta=G.message||"Unknown Error",ka=G.name||"UnknownError",
Da=G.lineNumber||"Not available",ui=G.fileName||"Not available",vi=G.stack||u.f||"Not available";if(u.hasOwnProperty("args")&&u.args&&u.args.length)for(var qa=0,Mb=0;Mb<u.args.length;Mb++){var Q=u.args[Mb],Aa="params."+Mb;qa+=Aa.length;if(Q)if(Array.isArray(Q)){for(var wi=w,ad=qa,cb=0;cb<Q.length&&!(Q[cb]&&(ad+=ji(cb,Q[cb],Aa,wi),500<ad));cb++);qa=ad}else if("object"===typeof Q){var Nb=void 0,xi=w,bd=qa;for(Nb in Q)if(Q[Nb]&&(bd+=ji(Nb,Q[Nb],Aa,xi),500<bd))break;qa=bd}else w[Aa]=String(JSON.stringify(Q)).substring(0,
500),qa+=w[Aa].length;else w[Aa]=String(JSON.stringify(Q)).substring(0,500),qa+=w[Aa].length;if(500<=qa)break}else if(u.hasOwnProperty("params")&&u.params){var Ob=u.params;if("object"===typeof u.params){var gf=0;for(p in Ob)if(Ob[p]){var hf="params."+p,jf=String(JSON.stringify(Ob[p])).substr(0,500);w[hf]=jf;gf+=hf.length+jf.length;if(500<gf)break}}else w.params=String(JSON.stringify(Ob)).substr(0,500)}navigator.vendor&&!w.hasOwnProperty("vendor")&&(w.vendor=navigator.vendor);var cd={message:Ta,name:ka,
lineNumber:Da,fileName:ui,stack:vi,params:w},kf=Number(u.columnNumber);isNaN(kf)||(cd.lineNumber=cd.lineNumber+":"+kf);for(var ea,Ba=cd,lf=v(ci),dd=lf.next();!dd.done;dd=lf.next()){var ed=dd.value;if(ed.R[Ba.name])for(var mf=v(ed.R[Ba.name]),fd=mf.next();!fd.done;fd=mf.next()){var nf=fd.value,Pb=Ba.message.match(nf.regexp);if(Pb){Ba.params["error.original"]=Pb[0];for(var gd=nf.groups,of={},La=0;La<gd.length;La++)of[gd[La]]=Pb[La+1],Ba.params["error."+gd[La]]=Pb[La+1];Ba.message=ed.W(of);break}}}ea=
Ba;window.yterr&&"function"===typeof window.yterr&&window.yterr(ea);if(!(gi.has(ea.message)||0<=ea.stack.indexOf("/YouTubeCenter.js")||0<=ea.stack.indexOf("/mytube.js"))){fi.J("handleError",ea);if(T("kevlar_gel_error_routing")){var Qb=void 0,pf=m,N=ea;a:{for(var qf=v(ii),hd=qf.next();!hd.done;hd=qf.next()){var rf=H;if(rf&&0<=rf.toLowerCase().indexOf(hd.value.toLowerCase())){var sf=!0;break a}}sf=!1}if(!sf){var db={stackTrace:N.stack};N.fileName&&(db.filename=N.fileName);var fa=N.lineNumber&&N.lineNumber.split?
N.lineNumber.split(":"):[];0!==fa.length&&(1!==fa.length||isNaN(Number(fa[0]))?2!==fa.length||isNaN(Number(fa[0]))||isNaN(Number(fa[1]))||(db.lineNumber=Number(fa[0]),db.columnNumber=Number(fa[1])):db.lineNumber=Number(fa[0]));var yi=N.message,zi=N.name;ei||(ei=new di);var tf=ei;a:{for(var uf=v(tf.g),id=uf.next();!id.done;id=uf.next()){var vf=id.value;if(N.message&&N.message.match(vf.f)){var jd=vf.weight;break a}}for(var wf=v(tf.f),kd=wf.next();!kd.done;kd=wf.next()){var xf=kd.value;if(xf.f(N)){jd=
xf.weight;break a}}jd=1}var ld={level:"ERROR_LEVEL_UNKNOWN",message:yi,errorClassName:zi,sampleWeight:jd};"ERROR"===pf?ld.level="ERROR_LEVEL_ERROR":"WARNING"===pf&&(ld.level="ERROR_LEVEL_WARNNING");var Ai={isObfuscated:!0,browserStackInfo:db},Rb={pageUrl:window.location.href,kvPairs:[]},md=N.params;if(md)for(var yf=v(Object.keys(md)),nd=yf.next();!nd.done;nd=yf.next()){var zf=nd.value;Rb.kvPairs.push({key:"client."+zf,value:String(md[zf])})}var Af=P("SERVER_NAME",void 0),Bf=P("SERVER_VERSION",void 0);
Af&&Bf&&(Rb.kvPairs.push({key:"server.name",value:Af}),Rb.kvPairs.push({key:"server.version",value:Bf}));var Bi={errorMetadata:Rb,stackTrace:Ai,logMessage:ld};Qb=void 0===Qb?{}:Qb;var Cf=bi;P("ytLoggingEventsDefaultDisabled",!1)&&bi==bi&&(Cf=null);var Ci=Cf,V=Qb;V=void 0===V?{}:V;var eb={};eb.eventTimeMs=Math.round(V.timestamp||U());eb.clientError=Bi;var Di=String;if(V.timestamp)var Df=-1;else{var Ef=B("_lact",window);if(null==Ef)var Ff=-1;else{var Ei=Ef;Ff=Math.max(C()-Ei,0)}Df=Ff}eb.context={lastActivityMs:Di(Df)};
if(T("log_sequence_info_on_gel_web")&&V.ca){var Fi=eb.context,fb=V.ca;fg[fb]=fb in fg?fg[fb]+1:0;Fi.sequence={index:fg[fb],groupKey:fb};V.Ga&&delete fg[V.ca]}var Gi=eb,Sb=V.Fa,Gf=Ci,od="";if(Sb){var Tb=Sb,pd={};Tb.videoId?pd.videoId=Tb.videoId:Tb.playlistId&&(pd.playlistId=Tb.playlistId);Xf[Sb.token]=pd;od=Sb.token}var qd=Wf.get(od)||[];Wf.set(od,qd);qd.push(Gi);Gf&&(Qf=new Gf);var Hi=Ve("web_logging_max_batch")||100,Hf=U();qd.length>=Hi?Yf():10<=Hf-Tf&&($f(),Tf=Hf);Yf()}}var rd,Ca=ea,gb=Ca.params||
{},ra={oa:{a:"logerror",t:"jserror",type:Ca.name,msg:Ca.message.substr(0,250),line:Ca.lineNumber,level:m,"client.name":gb.name},u:{url:P("PAGE_NAME",window.location.href),file:Ca.fileName},method:"POST"};gb.version&&(ra["client.version"]=gb.version);if(ra.u){Ca.stack&&(ra.u.stack=Ca.stack);for(var If=v(Object.keys(gb)),sd=If.next();!sd.done;sd=If.next()){var Jf=sd.value;ra.u["client."+Jf]=gb[Jf]}if(rd=P("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var Kf=v(Object.keys(rd)),td=Kf.next();!td.done;td=
Kf.next()){var Lf=td.value;ra.u[Lf]=rd[Lf]}var Mf=P("SERVER_NAME",void 0),Nf=P("SERVER_VERSION",void 0);Mf&&Nf&&(ra.u["server.name"]=Mf,ra.u["server.version"]=Nf)}ug(P("ECATCHER_REPORT_HOST","")+"/error_204",ra);gi.add(ea.message);hi++}}}}}else throw Ka;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function pi(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
sa(Z,Y);q=Z.prototype;q.N=function(){return"/embed/"+S(this.g,"videoId")};
q.M=function(){var a=S(this.g,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!=window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=S(this.g,"embedConfig")){if(Sa(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
q.ba=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Sa(a))for(var c in a)this.C[c]=a[c];break;case "infoDelivery":ri(this,a);break;case "initialDelivery":window.clearInterval(this.h);this.playerInfo={};this.C={};si(this,a.apiInterface);ri(this,a);break;default:this.K(b,a)}};
function ri(a,b){if(Sa(b))for(var c in b)a.playerInfo[c]=b[c]}
function si(a,b){F(b,function(c){this[c]||("getCurrentTime"==c?this[c]=function(){var d=this.playerInfo.currentTime;if(1==this.playerInfo.playerState){var e=(C()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:pi(c)?this[c]=function(){this.playerInfo={};
...
return this})},a)}
q.getVideoEmbedCode=function(){var a=parseInt(S(this.g,"width"),10),b=parseInt(S(this.g,"height"),10),c=S(this.g,"host")+this.N();Cb.test(c)&&(-1!=c.indexOf("&")&&(c=c.replace(wb,"&amp;")),-1!=c.indexOf("<")&&(c=c.replace(xb,"&lt;")),-1!=c.indexOf(">")&&(c=c.replace(yb,"&gt;")),-1!=c.indexOf('"')&&(c=c.replace(zb,"&quot;")),-1!=c.indexOf("'")&&(c=c.replace(Ab,"&#39;")),-1!=c.indexOf("\x00")&&(c=c.replace(Bb,"&#0;")));return'<iframe width="'+a+'" height="'+b+'" src="'+c+'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'};
...
function ti(a){if("iframe"!=a.tagName.toLowerCase()){var b=R(a,"videoid");b&&(b={videoId:b,width:R(a,"width"),height:R(a,"height")},new Z(a,b))}}
;function Ii(a,b){var c={title:"Thumbnail",videoId:"",width:120,height:68};if(b)for(var d in b)c[d]=b[d];Y.call(this,a,c,"thumbnail")}
sa(Ii,Y);Ii.prototype.N=function(){return"/embed/"+S(this.g,"videoId")};
...
function Ji(a){if("iframe"!=a.tagName.toLowerCase()){var b=R(a,"videoid");if(b){b={videoId:b,events:{},width:R(a,"width"),height:R(a,"height"),thumbWidth:R(a,"thumb-width"),thumbHeight:R(a,"thumb-height"),thumbAlign:R(a,"thumb-align")};var c=R(a,"onclick");c&&(b.events.onClick=c);new Ii(a,b)}}}
...
D("YT.scan",Oe);D("YT.subscribe",function(a,b,c){Zd.subscribe(a,b,c);Ne[a]=!0;for(var d in Le)mi(Le[d],a)});
D("YT.unsubscribe",function(a,b,c){Yd(a,b,c)});
D("YT.Player",Z);D("YT.Thumbnail",Ii);Y.prototype.destroy=Y.prototype.destroy;Y.prototype.setSize=Y.prototype.setSize;Y.prototype.getIframe=Y.prototype.na;Y.prototype.addEventListener=Y.prototype.addEventListener;Z.prototype.getVideoEmbedCode=Z.prototype.getVideoEmbedCode;Z.prototype.getOptions=Z.prototype.getOptions;Z.prototype.getOption=Z.prototype.getOption;Me.push(function(a){a=Pe("player",a);F(a,ti)});
Me.push(function(){var a=Pe("thumbnail");F(a,Ji)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Oe();var Ki=A.onYTReady;Ki&&Ki();var Li=A.onYouTubeIframeAPIReady;Li&&Li();var Mi=A.onYouTubePlayerAPIReady;Mi&&Mi();}).call(this);
